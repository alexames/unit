...
describe('satisfy_any API', function()
  it('should work with to.satisfy_any', function()
    expect(5).to.satisfy_any(matchers_module.equals(5), matchers_module.equals(10))
    expect(10).to.satisfy_any(matchers_module.equals(5), matchers_module.equals(10))
    
    local success = pcall(function()
      expect(7).to.satisfy_any(matchers_module.equals(5), matchers_module.equals(10))
    end)
    expect(success).to.be_equal_to(false)
  end)

  it('should work with to_not.satisfy_any', function()
    expect(7).to_not.satisfy_any(matchers_module.equals(5), matchers_module.equals(10))
    
    local success = pcall(function()
      expect(5).to_not.satisfy_any(matchers_module.equals(5), matchers_module.equals(10))
    end)
    expect(success).to.be_equal_to(false)
  end)
end)
